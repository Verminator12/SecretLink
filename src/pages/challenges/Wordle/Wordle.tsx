...
export const Wordle: React.FC<WordleProps> = ({ parameters, onComplete }) => {
  ...
  const targetWord = parameters.toUpperCase()
  const maxAttempts = 6
    ...
    <div className={styles.container}>
      ...
      {gameOver && (
        <div className={styles.gameOver}>
          <p>
            {t.challenges.wordle.gameOver.replace('{word}', targetWord)}
          </p>
          <SLButton onClick={handleRetry} center>
